...
async def cmd_start(message: Message):
    ...
    if is_new_user:
        await message.answer(
            ...
            "Freeth — это сервис защищенного интернет-подключения для личного использования.\n"
            "Он помогает безопасно работать в публичных Wi-Fi сетях, защищать трафик "
            "и быстро получать доступ к настройкам подключения.\n\n"
            "Что доступно в боте:\n"
